...
async function startconn() {
    ...
    console.log(chalk.cyan(`║        🤖 SPAIDO BOT PAIRING MODE       ║`))
    console.log(chalk.cyan(`╚════════════════════════════════════╝`))
...
┗❐═⭔════════⭔═❐`,
            ...
            await delay(1999)
            console.log(chalk.yellow(`\n\n    ${chalk.bold.blue(`[ ${global.botname || 'SPAIDO BOT'} ]`)}\n\n`))
            console.log(chalk.cyan(`< ================================================== >`))
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: SPAIDOHACKS OFFICIAL`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: ahmadtech12`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: SPAIDO HACKS TEAM`))
            console.log(chalk.green(`${global.themeemoji || '•'} 🤖 SPAIDO BOT Connected Successfully! ✅`))
            console.log(chalk.cyan(`< ================================================== >`))
        }
        if (
            connection === "close" &&
